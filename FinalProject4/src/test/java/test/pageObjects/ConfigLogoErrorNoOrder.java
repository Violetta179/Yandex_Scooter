...
public class ConfigLogoErrorNoOrder
{
    ...
    public ConfigLogoErrorNoOrder(org.openqa.selenium.WebDriver driver) {
        this.driver = driver;
        driver.get(host);
   ...
   public void getTrueUrl(String url)
   {
    ...
    public void getMessageErrorFormTwo()
    {
            ...
            assertTrue(driver.findElement(PageOrder.errorArrival).isDisplayed());
            assertTrue(driver.findElement(PageOrder.errorPeriod).isDisplayed());
            assertTrue(driver.findElement(PageOrder.errorColor).isDisplayed());
    }
